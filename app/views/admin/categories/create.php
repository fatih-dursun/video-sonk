    ...
    <div class="admin-container">
        ...
        <form method="POST" enctype="multipart/form-data" class="admin-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="categoryName" class="form-control" placeholder="örn: 🎬 Filmler" required>
            </div>
                ...
                <div class="demo-grid">
                    <div class="demo-item">
                        ...
                        <div class="demo-category-card" id="demoCard">
                            <div class="demo-category-name" id="demoCategoryName">Kategori</div>
                    ...
                    <div class="demo-item">
                        <label>Badge</label>
                        <span class="demo-badge" id="demoBadge">Kategori</span>
                    </div>

                    <div class="demo-item">
                        <label>Başlık</label>
                        <div class="demo-header" id="demoHeader">
                            <h4 id="demoHeaderTitle">Kategori</h4>
                            <p>24 video</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="color-picker-section">
                    ...
                    <div class="color-picker-column">
                        <div class="color-picker-group">
                            ...
                            <input type="text" class="color-hex" id="bgHex" value="#3B82F6" maxlength="7">
                        </div>
                        <div class="color-picker-group">
                            <label>Yazı:</label>
                            <input type="color" id="text_color" name="text_color" value="#FFFFFF">
                            <input type="text" class="color-hex" id="textHex" value="#FFFFFF" maxlength="7">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="logoPreview" class="logo-preview-container">
                    <img id="logoPreviewImg" src="" alt="Logo Önizleme">
                </div>
            </div>
